...
using Sag.Service.Companies.Api.Controllers;
using Sag.Service.Companies.Api.Specs.StepDefinitions;
using System.Net;
using System.Net.Http.Headers;
using TechTalk.SpecFlow;

namespace Sag.Service.Companies.Api.Specs.Features.Config
{
    ...
    public sealed class ConfigurationStepDefinitions : BaseStepDefinitions
    {
        ...
        public static async Task VerifySwagger()
        {
            ...
            var jsonResponse = await Client.GetAsync("/v1/swagger.json");
