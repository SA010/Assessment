...
//TODO: using Sag.Service.Identity.Models;
using System.Net;
        ...
        public async Task ThenResponseStatusCodeShouldBe(string expectedStatus)
        {
            ...
            if (Enum.TryParse(expectedStatus, true, out HttpStatusCode expectedStatusCode))
            {
                expectedErrorCode = expectedStatusCode switch
                {
                    ...
                    //TODO: //HttpStatusCode.Unauthorized => IdentityErrorCode.HttpStatus401.MissingToken,
                    //HttpStatusCode.Forbidden => IdentityErrorCode.HttpStatus403.UserRights,
